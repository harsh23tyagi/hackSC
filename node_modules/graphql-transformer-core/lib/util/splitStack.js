...
function splitStack(opts) {
    ...
    function createMapByStackRules(keys) {
        ...
        var _loop_1 = function (key) {
            stackRules.forEach(function (stackName, regExStr) {
     ...
     */
    function collectTemplates(template, resourceToStackMap, outputToStackMap) {
        ...
        var _loop_2 = function (resourceId) {
            ...
            if (!templateMap[stackName]) {
                templateMap[stackName] = blankTemplate_1.default({
                    ...
                    Parameters: __assign({}, template.Parameters, defaultParameterDefinitions),
    ...
    function replaceReferences(stacks, resourceToStackMap) {
        ...
        var stackDependsOnMap = Object.keys(stacks).reduce(function (acc, k) {
            var _a;
            return (__assign({}, acc, (_a = {}, _a[k] = [], _a)));
        }, {});
        ...
        for (var _i = 0, _a = Object.keys(stacks); _i < _a.length; _i++) {
            ...
            var _loop_3 = function (resourceId) {
                ...
                for (var _i = 0, references_1 = references; _i < references_1.length; _i++) {
                    ...
                    var getAttNeedsReplacing = refNode
                        && refNode['Fn::GetAtt']
                        && referencedStackName
                        && referencedStackName !== thisStackName;
    ...
    function makeImportValueForRef(resourceId) {
        return cloudform_types_1.Fn.ImportValue(cloudform_types_1.Fn.Join(':', [
            importExportPrefix,
            'Ref',
            resourceId
        ]));
    ...
    function makeOutputForGetAtt(resourceId, attribute) {
        return {
            ...
            Export: {
                Name: cloudform_types_1.Fn.Join(':', [
                    importExportPrefix,
                    'GetAtt',
                    resourceId,
                    attribute
    ...
    function updateRootWithNestedStacks(root, stacks, stackInfo) {
        ...
        var allParamValues = allParamNames.reduce(function (acc, name) {
            var _a;
            return (__assign({}, acc, (_a = {}, _a[name] = cloudform_types_1.Fn.Ref(name), _a)));
        ...
        for (var _i = 0, stackFileNames_1 = stackFileNames; _i < stackFileNames_1.length; _i++) {
            ...
            var stackResource = new cloudform_types_1.CloudFormation.Stack({
                Parameters: __assign({}, allParamValues, extraParams),
            ...
            }).dependsOn(defaultDependencies.concat(dependsOnStacks));
    ...
    var stacks = collectTemplates(templateJson, resourceToStackMap, outputToStackMap);
