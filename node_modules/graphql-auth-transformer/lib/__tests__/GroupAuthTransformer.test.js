...
test('Test ModelAuthTransformer validation happy case w/ static groups', function () {
    ...
    var transformer = new graphql_transformer_core_1.default({
        transformers: [
            ...
            new ModelAuthTransformer_1.ModelAuthTransformer({ authMode: 'AMAZON_COGNITO_USER_POOLS' })
        ]
    });
...
test('Test ModelAuthTransformer validation happy case w/ dynamic groups', function () {
...
test('Test ModelAuthTransformer validation happy case w/ dynamic group', function () {
...
test('Test ModelAuthTransformer validation @auth on non @model. Should fail.', function () {
    try {
