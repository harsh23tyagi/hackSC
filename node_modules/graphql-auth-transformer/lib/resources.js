...
var graphQlApi_1 = require("cloudform-types/types/appSync/graphQlApi");
...
var ResourceFactory = /** @class */ (function () {
    ...
    ResourceFactory.prototype.makeParams = function () {
        var _a;
        return _a = {},
            _a[graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolId] = new cloudform_types_1.StringParameter({
    ...
    ResourceFactory.prototype.initTemplate = function () {
        ...
        return {
            ...
            Outputs: (_b = {},
                ...
                _b),
            Conditions: (_c = {},
                _c[graphql_transformer_common_1.ResourceConstants.CONDITIONS.ShouldCreateAPIKey] = cloudform_types_1.Fn.And([
                    ...
                    cloudform_types_1.Fn.Equals(cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolId), graphql_transformer_common_1.ResourceConstants.NONE)
                ]),
                _c[graphql_transformer_common_1.ResourceConstants.CONDITIONS.APIKeyExpirationEpochIsPositive] = cloudform_types_1.Fn.And([
                    cloudform_types_1.Fn.Not(cloudform_types_1.Fn.Equals(cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.APIKeyExpirationEpoch), -1)),
    ...
    ResourceFactory.prototype.makeAppSyncApiKey = function () {
        ...
        return new cloudform_types_1.AppSync.ApiKey({
            ...
            Expires: cloudform_types_1.Fn.If(graphql_transformer_common_1.ResourceConstants.CONDITIONS.APIKeyExpirationEpochIsPositive, cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.APIKeyExpirationEpoch), nowEpochTime + oneWeekFromNowInSeconds),
    ...
    ResourceFactory.prototype.updateGraphQLAPIWithAuth = function (apiRecord, authMode) {
        return new graphQlApi_1.default(__assign({}, apiRecord.Properties, { Name: apiRecord.Properties.Name, AuthenticationType: authMode, UserPoolConfig: authMode === 'AMAZON_COGNITO_USER_POOLS' ?
                new graphQlApi_1.UserPoolConfig({
    ...
    ResourceFactory.prototype.setUserGroups = function () {
        return graphql_mapping_template_1.set(graphql_mapping_template_1.ref('userGroups'), graphql_mapping_template_1.raw('$util.defaultIfNull($ctx.identity.claims.get("cognito:groups"), [])'));
    };
