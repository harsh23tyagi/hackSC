...
var validateAuthMode = function (mode) {
    if (mode !== 'API_KEY' &&
...
var ModelAuthTransformer = /** @class */ (function (_super) {
    ...
    function ModelAuthTransformer(config) {
        ...
        _this.updateAPIForUserPools = function (ctx) {
            ...
            var updated = _this.resources.updateGraphQLAPIWithAuth(apiRecord, _this.config.authMode);
        ...
        _this.config = config || { authMode: 'API_KEY' };
        validateAuthMode(_this.config.authMode);
